...
export class CreateSchoolComponent extends BaseComponent<SchoolModel> implements OnInit {
  ...
  createSchoolForm(): FormGroup {
    return this.formBuilder.group({
      ...
      Village: new FormControl({ value: this.schoolModel.Village, disabled: this.PageRights.IsReadOnly }, [Validators.maxLength(150), Validators.pattern(this.Constants.Regex.AlphaNumericWithDashDotMinusSpace)]),
      Panchayat: new FormControl({ value: this.schoolModel.Panchayat, disabled: this.PageRights.IsReadOnly }, [Validators.maxLength(150), Validators.pattern(this.Constants.Regex.AlphaNumericWithDashDotMinusSpace)]),
