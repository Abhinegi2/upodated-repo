...
export class CreateEmailBrodcastingComponent extends BaseComponent<EmailBroadcastingModel> implements OnInit {
  ...
  messageTemplateModel: EmailBroadcastingModel;
  ...
  constructor(public commonService: CommonService,
    ...
    this.messageTemplateModel = new EmailBroadcastingModel();
  ...
  createMessageTemplateForm(): FormGroup {
    return this.formBuilder.group({
      ...
      MessageBody: new FormControl({ value: this.messageTemplateModel.MessageBody, disabled: this.PageRights.IsReadOnly }, Validators.maxLength(750)),
